          ...
          <div className="overflow-y-auto" style={{ maxHeight: "24rem" }}>
            <ul className="p-6 space-y-6">
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Khushi Singh</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Tarun Kumar</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Gurkirat Singh</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Vaibhav Rajput</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Anushka Singh</span>
                <span className="ml-auto font-semibold">8.2</span>
              </li>
              <li className="flex items-center">
                <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                ...
                <span className="text-gray-600">Mitali Knachan</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Vinayak Baranwal</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Batman</span>
